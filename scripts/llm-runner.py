...
def main():
    ...
    while turn < args.max_turns:
        ...
        if not action:
            # The agent replied with something we can't parse as an action. Don't
            # play for it — just log and re-request next turn.
            record({"event": "unparsed", "turn": turn, "reply": reply[:200]})
